...
internal class Jumpscare : EffectBase
{
    public Jumpscare() : base("Jumpscare", 10, EffectTypes.POST_PROCESS) { }
#pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
    static Jumpscare()
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
    {
        GameObject go = new("Chaos Video Player - Jumpscare");
        ...
        player.Persist();
        rTex.Persist();
        player.prepareCompleted += (new System.Action<VideoPlayer>(_ => ScarePlayer()));
        player.loopPointReached += (new System.Action<VideoPlayer>(_ => SharedPostProcessingMaterials.GreenScreen.Disable()));
    }

    static string[] paths = GlobalVariables.ResourcePaths.Where(p => p.ToLower().Contains("assets/greenscreens/jumpscares")).ToArray();
    ...
    {
        { "withered foxy", new Color32(0, 216, 0, 0) },
        { "ishowspeed", new Color32(18, 255, 0, 0) },
        { "balloonboy" , new Color32(68, 202, 53, 0) },
        { "marionette" , new Color32(68, 202, 53, 0) },
        { "springtrap" , new Color32(68, 202, 53, 0) },
    };
    ...
    static void ScarePlayer()
    {
        ...
        SharedPostProcessingMaterials.GreenScreen.Tolerance.SetOn(SharedPostProcessingMaterials.GreenScreen.Material, 0.5f);
    }
}
