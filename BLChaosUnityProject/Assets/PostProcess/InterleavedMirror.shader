Shader "extraes/InterleavedMirror"
{
    Properties
    {
        [MainTexture] _MainTex("_MainTex", any) = "" {}
        _InterleaveScale("_InterleaveScale", Float) = 500
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                IN.uv.x = cos(IN.uv.x * _InterleaveScale) > 0 ? 1 - IN.uv.x : IN.uv.x;
