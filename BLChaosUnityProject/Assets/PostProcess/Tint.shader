Shader "extraes/Tint"
{
    Properties
    {
        ...
        _TimeMult("_TimeMult", Float) = 10
        _DepthMult("_DepthMult", Float) = 1000
        _SaturationMult("_SaturationMult", Float) = 5
        _MinSaturation_PostMult("_MinSaturation_PostMult", Float) = 0.1
    }
    ...
    SubShader
    {
        ...
        float _DepthMult;
        half _TimeMult;
        half _SaturationMult;
        half _MinSaturation_PostMult;
        CBUFFER_END
        ...
        Pass
        {
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                hsv.x += (_Time * _TimeMult) + (depth * _DepthMult);
                
                hsv.y *= _SaturationMult;

                hsv.y = max(hsv.y, _MinSaturation_PostMult);
