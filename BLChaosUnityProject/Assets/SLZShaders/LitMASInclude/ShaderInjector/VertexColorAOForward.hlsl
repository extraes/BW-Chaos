...
// End Injection VERTEX_END from Injection_VertexColorAO.hlsl ----------------------------------------------------------
    ...
    #if defined(ACID)
    float dist = max(distance(_WorldSpaceCameraPos, o.wPos.xyz) - 20, 0);
    o.vertex.y -= dist;
    o.wPos.y -= dist;
    #endif
...
// Begin Injection FRAG_POST_READ from Injection_VertexColorAO.hlsl ----------------------------------------------------------
	_BaseColor = lerp(1, _BaseColor, albedo.a);
// End Injection FRAG_POST_READ from Injection_VertexColorAO.hlsl ----------------------------------------------------------
