    ...
    private void OnGUI()
    {
        ...
        foreach (string bundle in bundles)
        {
            ...
            if (GUILayout.Button("Build", EditorStyles.miniButton))
            {
                ...
                BuildPipeline.BuildAssetBundles(Application.temporaryCachePath, new AssetBundleBuild[] { assetBundleBuild }, BuildAssetBundleOptions.ChunkBasedCompression, EditorUserBuildSettings.activeBuildTarget);
                ...
                try { File.Move(Application.temporaryCachePath + "/" + fileName, savePath); }
                    ...
                    File.Delete(Application.temporaryCachePath + "/" + fileName + ".manifest");
