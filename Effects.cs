...
namespace BW_Chaos.Effects
{
    ...
    public class PlayerGravity : IChaosEffect
    {
        ...
        private List<Rigidbody> WHOTHEFUCKGAVEMEACCESSTOCSHARPWHENITHASZERORESTRICTIONSONVARIABLENAMINGOTHERTHANBEINGALPHANUMERIC = new List<Rigidbody> { };
        private bool  = false;
        private bool TOQUOTETHEWISEADAMDEVELOPER_LOL_WHAT_THE_FUCK = true;
        private object[] YOUWILLBERENAMEDTOHOIST_THATISNOTATHREATTHATISAPROMISE = new object[2];
        public void EffectStarts()
        {
             = false;
            TOQUOTETHEWISEADAMDEVELOPER_LOL_WHAT_THE_FUCK = true;
            YOUWILLBERENAMEDTOHOIST_THATISNOTATHREATTHATISAPROMISE[0] = MelonCoroutines.Start(BALLINBUTATWHATCOST());
            YOUWILLBERENAMEDTOHOIST_THATISNOTATHREATTHATISAPROMISE[1] = MelonCoroutines.Start(LETSMAKEADEALBITCHBEFORREALISYOUOFFAPILLOKAYLETSMAKEADEALRUMPELSTILTSKINHMSHEWANNASEEMYPURPLEPICKLEUPINTHEWINDOKAYCHANCLETASOFFBITCHGETINAYYAYYANDIFYOUR_());
        }
        public void EffectEnds()
        {
             = true;
            MelonCoroutines.Stop(YOUWILLBERENAMEDTOHOIST_THATISNOTATHREATTHATISAPROMISE[0]);
            MelonCoroutines.Stop(YOUWILLBERENAMEDTOHOIST_THATISNOTATHREATTHATISAPROMISE[1]);
        }

        private IEnumerator LETSMAKEADEALBITCHBEFORREALISYOUOFFAPILLOKAYLETSMAKEADEALRUMPELSTILTSKINHMSHEWANNASEEMYPURPLEPICKLEUPINTHEWINDOKAYCHANCLETASOFFBITCHGETINAYYAYYANDIFYOUR_()
        {
            yield return new WaitForFixedUpdate();
            if () yield break;
            ...
            if (!TOQUOTETHEWISEADAMDEVELOPER_LOL_WHAT_THE_FUCK)
            {
                var SNEEDFROMSNEEDSFEEDANDSEED = WHOTHEFUCKGAVEMEACCESSTOCSHARPWHENITHASZERORESTRICTIONSONVARIABLENAMINGOTHERTHANBEINGALPHANUMERIC.ToArray();
                int colon_nut_colon = 0;
                foreach (var YUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYE_CHORUS_YUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYE_YUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYE in SNEEDFROMSNEEDSFEEDANDSEED)
                {
                    if ( || YUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYE_CHORUS_YUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYE_YUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYE == null) yield break;
                    colon_nut_colon++;
                    if (colon_nut_colon % 5 == 0) MYSUPERMEGALASERPISSJUSTLIKEEGGMANSBUTBETTERANDMOREEPIC = GameObject.FindObjectOfType<PhysBody>().rbHead.transform.position;
                    YUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYE_CHORUS_YUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYE_YUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYEYUHYUHYUHAYE.AddExplosionForce(-2f, MYSUPERMEGALASERPISSJUSTLIKEEGGMANSBUTBETTERANDMOREEPIC, 10, 2, ForceMode.VelocityChange);
                    yield return new WaitForFixedUpdate();
                }
            }
            MelonCoroutines.Start(LETSMAKEADEALBITCHBEFORREALISYOUOFFAPILLOKAYLETSMAKEADEALRUMPELSTILTSKINHMSHEWANNASEEMYPURPLEPICKLEUPINTHEWINDOKAYCHANCLETASOFFBITCHGETINAYYAYYANDIFYOUR_());
        }

        private IEnumerator BALLINBUTATWHATCOST()
        {
            if () yield break;

            // Don't modify the rigidbody list without marking it
            TOQUOTETHEWISEADAMDEVELOPER_LOL_WHAT_THE_FUCK = true;
            WHOTHEFUCKGAVEMEACCESSTOCSHARPWHENITHASZERORESTRICTIONSONVARIABLENAMINGOTHERTHANBEINGALPHANUMERIC.Clear();
            // Get the position of the player's head
            var YOGETUPINHERE_BROASITEONLY_BUTWHATIFIMTRYINGTOHITPONBYOUGETME = GameObject.FindObjectOfType<PhysBody>();
            if (YOGETUPINHERE_BROASITEONLY_BUTWHATIFIMTRYINGTOHITPONBYOUGETME == null) yield break;
            var VS2019FRENAMEALLREFERENCESMYBELOVED = YOGETUPINHERE_BROASITEONLY_BUTWHATIFIMTRYINGTOHITPONBYOUGETME.rbHead.transform.position;
            ...
            int TEXASINMYVOICECHANNELYOTHISTHISSTREAMJUSTGOTAWHOLELOTBETTERFELLAS_HELLO_NOOBDOG_SHUTUPWHATDOYOUWANT_IWANTYOUTOFUCKOFFANDSUCKMYDICK_FORWHATDUDE_YOUREJUSTAFUCKING_NONOIMDEADSERIOUSYOUREJUSTPICKINGONFUCKINPEOPLEWHODONTREALLYKNOWMUCH_YOURESELLINGCOPYPASTETOPEOPLEANDTELLINGTHEMTHATYOUSELFCODEITANDTHATYOUCANBYPASSESEAIDONTKNOWHOWYOUTHINKIMBULLYINGANYBODYYOURELITERALLYSCAMMINGPEOPLEYOUSAIDYOUSAIDAYYWAREBYPASSESESEAYOUKNOWYOUSAID_NOISAIDSOMEINTERNALSBYPASSESEAIDIDNTSAYAYYWARE = 0;

            foreach (Collider WHONEEDSOBFUSCATIONWHENYOUHAVEME_EXTRAES_AMIRIGHTLADIES in Physics.OverlapSphere(VS2019FRENAMEALLREFERENCESMYBELOVED, 10))
            {
                if ( || WHONEEDSOBFUSCATIONWHENYOUHAVEME_EXTRAES_AMIRIGHTLADIES == null) yield break;
                if (!(WHOTHEFUCKGAVEMEACCESSTOCSHARPWHENITHASZERORESTRICTIONSONVARIABLENAMINGOTHERTHANBEINGALPHANUMERIC.Contains(WHONEEDSOBFUSCATIONWHENYOUHAVEME_EXTRAES_AMIRIGHTLADIES.attachedRigidbody) || WHONEEDSOBFUSCATIONWHENYOUHAVEME_EXTRAES_AMIRIGHTLADIES.gameObject.transform.root.name == "[RigManager (Default Brett)]"))
                {
                    if (WHONEEDSOBFUSCATIONWHENYOUHAVEME_EXTRAES_AMIRIGHTLADIES.attachedRigidbody != null)
                        WHOTHEFUCKGAVEMEACCESSTOCSHARPWHENITHASZERORESTRICTIONSONVARIABLENAMINGOTHERTHANBEINGALPHANUMERIC.Add(WHONEEDSOBFUSCATIONWHENYOUHAVEME_EXTRAES_AMIRIGHTLADIES.attachedRigidbody);
                }
                TEXASINMYVOICECHANNELYOTHISTHISSTREAMJUSTGOTAWHOLELOTBETTERFELLAS_HELLO_NOOBDOG_SHUTUPWHATDOYOUWANT_IWANTYOUTOFUCKOFFANDSUCKMYDICK_FORWHATDUDE_YOUREJUSTAFUCKING_NONOIMDEADSERIOUSYOUREJUSTPICKINGONFUCKINPEOPLEWHODONTREALLYKNOWMUCH_YOURESELLINGCOPYPASTETOPEOPLEANDTELLINGTHEMTHATYOUSELFCODEITANDTHATYOUCANBYPASSESEAIDONTKNOWHOWYOUTHINKIMBULLYINGANYBODYYOURELITERALLYSCAMMINGPEOPLEYOUSAIDYOUSAIDAYYWAREBYPASSESESEAYOUKNOWYOUSAID_NOISAIDSOMEINTERNALSBYPASSESEAIDIDNTSAYAYYWARE++;
                if (TEXASINMYVOICECHANNELYOTHISTHISSTREAMJUSTGOTAWHOLELOTBETTERFELLAS_HELLO_NOOBDOG_SHUTUPWHATDOYOUWANT_IWANTYOUTOFUCKOFFANDSUCKMYDICK_FORWHATDUDE_YOUREJUSTAFUCKING_NONOIMDEADSERIOUSYOUREJUSTPICKINGONFUCKINPEOPLEWHODONTREALLYKNOWMUCH_YOURESELLINGCOPYPASTETOPEOPLEANDTELLINGTHEMTHATYOUSELFCODEITANDTHATYOUCANBYPASSESEAIDONTKNOWHOWYOUTHINKIMBULLYINGANYBODYYOURELITERALLYSCAMMINGPEOPLEYOUSAIDYOUSAIDAYYWAREBYPASSESESEAYOUKNOWYOUSAID_NOISAIDSOMEINTERNALSBYPASSESEAIDIDNTSAYAYYWARE % 5 == 0) yield return new WaitForFixedUpdate();
                if () yield break;

            }
            TOQUOTETHEWISEADAMDEVELOPER_LOL_WHAT_THE_FUCK = false;

            yield return new WaitForSecondsRealtime(1);
            MelonCoroutines.Start(BALLINBUTATWHATCOST());
        }
    }
    ...
    public class PlayerInverseGravity : IChaosEffect
    {
        ...
        private object[] EXAGGERATEDSWAGGEROFAWHITETEENWITHGLASSESLIVINGINACALIFORNIASUBURBNAMEDCHESMOND_THEJOKEISTHATITOLDCAMOBIWONIWEARGLASSESANDTHATMYNAMEWASCHESMONDWHENHEPREVIOUSLYTHOUGHTITWASCAMERONLIKEHIS = new object[2];
        public void EffectStarts()
        {
            SUPERMEGATAXAUDITING_MEANSDONTDOSHITWHENISAYSO = false;
            DONTTOUCHMYBALLSIWILLCALLTHEPOLICEONYOUANDGETARESTRAININGORDER = true;
            EXAGGERATEDSWAGGEROFAWHITETEENWITHGLASSESLIVINGINACALIFORNIASUBURBNAMEDCHESMOND_THEJOKEISTHATITOLDCAMOBIWONIWEARGLASSESANDTHATMYNAMEWASCHESMONDWHENHEPREVIOUSLYTHOUGHTITWASCAMERONLIKEHIS[0] = MelonCoroutines.Start(FUCKYOUUNITYFORNULLINGMYSHITOUT_ILLDOYOURMOMFORTHAT());
            EXAGGERATEDSWAGGEROFAWHITETEENWITHGLASSESLIVINGINACALIFORNIASUBURBNAMEDCHESMOND_THEJOKEISTHATITOLDCAMOBIWONIWEARGLASSESANDTHATMYNAMEWASCHESMONDWHENHEPREVIOUSLYTHOUGHTITWASCAMERONLIKEHIS[1] = MelonCoroutines.Start(EXPLOSIONFORCEISEPICBECAUSEYOURENOTDOINGTHINGSYOURSELF());
        }
        public void EffectEnds()
        {
            SUPERMEGATAXAUDITING_MEANSDONTDOSHITWHENISAYSO = true;
            MelonCoroutines.Stop(EXAGGERATEDSWAGGEROFAWHITETEENWITHGLASSESLIVINGINACALIFORNIASUBURBNAMEDCHESMOND_THEJOKEISTHATITOLDCAMOBIWONIWEARGLASSESANDTHATMYNAMEWASCHESMONDWHENHEPREVIOUSLYTHOUGHTITWASCAMERONLIKEHIS[0]);
            MelonCoroutines.Stop(EXAGGERATEDSWAGGEROFAWHITETEENWITHGLASSESLIVINGINACALIFORNIASUBURBNAMEDCHESMOND_THEJOKEISTHATITOLDCAMOBIWONIWEARGLASSESANDTHATMYNAMEWASCHESMONDWHENHEPREVIOUSLYTHOUGHTITWASCAMERONLIKEHIS[1]);
        }
        ...
        private IEnumerator EXPLOSIONFORCEISEPICBECAUSEYOURENOTDOINGTHINGSYOURSELF()
        {
            ...
            if (!DONTTOUCHMYBALLSIWILLCALLTHEPOLICEONYOUANDGETARESTRAININGORDER)
            {
                ...
                foreach (var THERIGHTBUMPERONTHEXBOX360ANDXBOXONEASWELLASXBOXSERIESXANDSCONTROLLERS in SNEEDFROMSNEEDSFEEDANDSEED)
                {
                    ...
                    THERIGHTBUMPERONTHEXBOX360ANDXBOXONEASWELLASXBOXSERIESXANDSCONTROLLERS.AddExplosionForce(3f, MYSUPERMEGALASERPISSJUSTLIKEEGGMANSBUTBETTERANDMOREEPIC, 10, 2, ForceMode.VelocityChange);
        ...
        private IEnumerator FUCKYOUUNITYFORNULLINGMYSHITOUT_ILLDOYOURMOMFORTHAT()
        {
            ...
            foreach (Collider CLUBFUCKINBANGINWHENWEBOPPINEXITTHISEARTHSATMOSPHEREBYCAMELLIA in Physics.OverlapSphere(playerPos, 7))
            {
