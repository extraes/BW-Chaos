...
namespace BWChaos.Effects
{
    ...
    {
        //PASTED CODE LMAO
        public Compton() : base("Compton", 60) {  }
        ...
        private void Init()
        {
            vineBoomSound = Resources.FindObjectsOfTypeAll<AudioClip>().FirstOrDefault(c => c.name == "light_pistol_gunshot2");
#if DEBUG
            Chaos.Log("Loaded the compton ambiance sound into Compton");
